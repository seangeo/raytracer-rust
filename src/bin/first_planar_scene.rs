...
fn main() {
    ...
    let left = Shape::sphere().
        ...
        transform(Matrix4x4::identity().scale(0.33, 0.33, 0.33).translate(-1.5, 1.35, -0.75));
    ...
    let right = Shape::sphere().
        ...
        transform(Matrix4x4::identity().scale(0.5, 0.5, 0.5).translate(1.5, -0.125, -0.5));
    ...
    println!("Writing ppm");
    let f = File::create("first_planar_scene.ppm").unwrap();
